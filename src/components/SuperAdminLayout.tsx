...
import { Bell, Scissors, LogOut, MessageSquare, LayoutDashboard, Menu, Store, Webhook } from "lucide-react";
...
const sidebarLinks = [
  ...
  { title: "Webhooks", icon: Webhook, href: "/webhooks" as const },
  { title: "Notificações", icon: Bell, href: "/notificacoes" as const },
