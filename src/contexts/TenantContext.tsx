...
export const TenantProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchTenant = async (forceSlug?: string) => {
    ...
    try {
      ...
      const reservedRoutes = ["admin", "login", "cadastro", "colaborador", "cliente", "atendimentos", "clientes", "colaboradores", "comunidade", "financeiro", "gastos", "horarios", "iacodconsumi", "iaimagem", "integracoes", "minhaconta", "promocao", "redefinir-senha", "registro", "servicos", "clube", "blog", "notificacoes", "barbearias", "superadmin", "superlogin"];
