...
function BarbeariaLanding() {
  ...
  if (!tenant) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-black text-white">
        <h1 className="text-2xl">Barbearia não encontrada</h1>
      </div>
    );
  }
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          >
            <div className="flex gap-4">
              ...
              <div className="text-muted-foreground text-slate-100 text-left">
            ...
            <div className="flex gap-4">
              ...
              <div className="text-muted-foreground text-slate-100 text-left">
                <h3 className="text-muted-foreground mb-2">Horário de Funcionamento</h3>
...
function Servicos({ tenantId }: { tenantId?: string }) {
  ...
  return (
    <section className="bg-secondary/20 px-4 py-[60px]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {time.map((c, i) => (
            ...
            >
              ...
              <div className="bg-card/50 p-6 rounded-2xl border border-primary/5 italic text-muted-foreground border-slate-600 text-slate-200">
                "{c.desc}"
              </div>
            </motion.div>
          ))}
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link to="/login" search={{ tenant: slug }} className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 transition-transform group-hover:translate-x-1" /> Login</Link></li>
            <li><Link to="/login" search={{ tenant: slug }} className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 group"><ChevronRight className="w-4 h-4 transition-transform group-hover:translate-x-1" /> Agendamento</Link></li>
