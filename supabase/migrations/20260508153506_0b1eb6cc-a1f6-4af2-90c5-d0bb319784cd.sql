...
BEGIN
  ...
  ELSIF (TG_OP = 'UPDATE') THEN
    -- Only trigger if data changed
    IF (OLD.data IS DISTINCT FROM NEW.data OR OLD.servicos_atendimento IS DISTINCT FROM NEW.servicos_atendimento OR OLD.colaborador_id IS DISTINCT FROM NEW.colaborador_id) THEN
